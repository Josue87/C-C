...
def show_help(extra= None):
    ...
    =============
        ...
        banner                     Show banner
        agents <list/kill [id]     Show agents or kill an agent
        listener <list/kill [id]   Show listeners or kill a listener
        tasks <list/kill> [id]     Show tasks running or kill a task
