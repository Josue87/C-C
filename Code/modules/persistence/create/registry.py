...
class RedTeamModule(AgentModule):
    ...
    def __init__(self):
        information = {"Name": "CreatePersistenceRegg",
                       "Description": "With this module you will be create an Registrykey with our trojan.",
                       "Author": "@josueencinar"}
    ...
    def run(self):
        ...
        rt_db.add_task(self.args["agent"], "CreatePersistenceReg", "", "", "function")
