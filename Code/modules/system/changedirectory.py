...
class RedTeamModule(AgentModule):
    ...
    def __init__(self):
        information = {"Name": "ChangeDirectory",
                       "Description": "With this module you will be able to change the current directory.",
                       "Author": "@josueencinar"}

        options = {
            "path": Option.create(name="path", description="Directory to change", required=True)
            }
    ...
    def run(self):
        ...
        rt_db.add_task(self.args["agent"], "ChangeCurrentDirectory" , self.args['path'], "", "function")
