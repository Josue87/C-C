...
class RedTeamModule(AgentModule):
    ...
    def __init__(self):
        information = {"Name": "GetCurrentDirectory",
                       "Description": "With this module you will be able to get the current directory.",
                       "Author": "@josueencinar"}
    ...
    def run(self):
        ...
        rt_db.add_task(self.args["agent"], "GetCurrentDirectory", "", "", "function")
