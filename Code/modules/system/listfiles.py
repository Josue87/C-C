...
class RedTeamModule(AgentModule):
    ...
    def __init__(self):
        information = {"Name": "ListFiles",
                       "Description": "With this module you will be able to get the files from the current directory.",
                       "Author": "@josueencinar"}
    ...
    def run(self):
        ...
        rt_db.add_task(self.args["agent"], "GetFiles", "", "", "function")
